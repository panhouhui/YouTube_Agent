...
from avtdl.core.loggers import LogLevel, override_loglevel, setup_file_logger
...
class SettingsSection(BaseModel):
    ...
    """configuration file encoding. Leave empty to use system-wide default"""
    cache_directory: Path = Field(default='cache/cache/', validate_default=True)
    """directory reserved for runtime cache data"""
